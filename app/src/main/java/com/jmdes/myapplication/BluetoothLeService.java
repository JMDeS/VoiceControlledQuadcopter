...
public class BluetoothLeService extends Service {
    ...
    //for data reception, service and sending the corresponding character
    // is determined by the change ble transparent transmission module
    public final static UUID UUID_NOTIFY =
            UUID.fromString("0000ffe1-0000-1000-8000-00805f9b34fb");
    public final static UUID UUID_SERVICE =
            UUID.fromString("0000ffe0-0000-1000-8000-00805f9b34fb");

    // for data reception, transmission, determined by the change ble
    ...
    // Writes a string to ble to send out
